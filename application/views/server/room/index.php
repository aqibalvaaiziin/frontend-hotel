<div class="cc">
    ...
    <div class="mb-3">
        <a href="<?= base_url().'server/room/tambah'; ?>" class="btnAddData rounded py-2 px-3">
    ...
    <table class="table" id="myTable">
      <thead class="thead-dark">
        <tr>
          ...
          <th scope="col" style="width:5%">NO_KAMAR</th>
      ...
      <tbody>
        <?php foreach($dataKamar->data as $k): ?>
          <tr>
            ...
            <td><?= $k->status ?></td>
            <td>
              <a href="<?= base_url().'server/room/edit/'.$k->id_kamar.'/'.$k->tipe; ?>" class="btn btn-warning"><i
                  class="fa fa-edit" style="font-size:15px"></i></a>
              <a href="<?= base_url().'server/room/delete/'.$k->id_kamar ?> " class="btn btn-danger"
