<img src="<?= base_url().'/assets/image/big_image_1.jpg' ?>" width="100%" height="768px" alt="" style="position:absolute;top:0">
...
<div class="container" style="margin-top:60%;margin-bottom:100px">
  <div class="box1 d-flex flex-row justify-content-between w-100">
    <div class="textBox1 text-center mr-4" style="margin-top:4rem">
